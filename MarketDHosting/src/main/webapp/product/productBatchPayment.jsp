    ...
    <div class="container">
      <div class="row">
		...
		<div class="col-lg-9 my-5">
				...
				<table class="table table-hover my-4">
					...
					<tbody>
						...
						<img src="${fileCallPath}" height="100" width="100"alt=""></a></th>
							...
							<td class="text-center">${alist2.pfee}원</td>
							<td class="text-center">0원</td>
						</tr>
						</c:forEach>	
						
						<c:set var="total" value="${totalpmoney+totalpfee}"/>
			...
			<form id="frmpp" action="${myContextPath}/Cart/shoppingCartBatchPaymentAction.dobby" method="post">
				<table class="table" id="focus">
					...
					<tbody>
						...
						<c:forEach items="${alist}" var="alist2" varStatus="status" >
							...
							<input type="hidden" value="${alist2.pidx}" name="pidx2">
							<input type="hidden" value="${alist2.pmoney+alist2.pfee}" name="omoney">
						...
						<tr>
						<td colspan="2" class="text-center align-middle" style="font-size: 15px;">총 ${fn:length(alist)}개 상품</td>
						<td colspan="5" class="text-right" style="font-size: 35px;">${total}</td>
