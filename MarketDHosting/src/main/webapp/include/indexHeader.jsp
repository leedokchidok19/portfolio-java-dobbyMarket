 ...
 <!-- Navigation -->
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav"">
    <div class="container">
      ...
      <form name="frm" id="frm" class="form-inline" action="${myContextPath}/Product/ProductList.dobby">
				<input class="form-control mr-sm-2 parent " type="search" id="keyword" name="keyword" value=""
					placeholder="어떤 물건을 찾으시나요?" aria-label="Search" size="30" style="width:250px">
